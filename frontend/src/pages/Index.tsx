    ...
    <div className="container relative">
      <div className="mx-auto max-w-3xl text-center">
        ...
        <p className="mb-8 text-lg text-muted-foreground md:text-xl">
          Quiz interactifs, examens simulés et corrections détaillées pour vous préparer efficacement aux concours en Côte d'Ivoire.
        </p>
  ...
  <section className="py-20">
    <div className="container">
      <div className="mb-12 text-center">
        ...
        <p className="mt-3 text-muted-foreground">Choisissez votre domaine et commencez à réviser</p>
      </div>
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                {quizzes.filter((q) => q.category === cat.id).length} quiz disponible(s)
              </p>
            </div>
          </Link>
        ))}
